...
using WebEmployeesSystem.Models;

namespace WebEmployeesSystem.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            var employees = db.Employees.Include(e => e.Employee1).Include(e => e.Position1).Include(e => e.City1).Include(e => e.Project);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.City = new SelectList(db.Cities, "CityName", "CityName");
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,Position,Salary,City,Email,Phone,ProjectName,Manager")] Employee employee)
        {
            ...
            ViewBag.City = new SelectList(db.Cities, "CityName", "CityName", employee.City);
            ViewBag.ProjectName = new SelectList(db.Projects, "ProjectName", "ProjectName", employee.ProjectName);
            return View(employee);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,Position,Salary,City,Email,Phone,ProjectName,Manager")] Employee employee)
        {
            if (ModelState.IsValid)
            {
